...
class Climate extends Base {
    ...
    withLocalTemperatureCalibration() {
        assert(!this.endpoint, 'Cannot add feature after adding endpoint');
        this.features.push(new Numeric('local_temperature_calibration', access.ALL).withUnit('°C').withDescription('Offset to be used in the local_temperature'));
        return this;
    }
...
module.exports = {
    ...
    presets: {
        // Colbee
        wind: () => new Text('wind', access.STATE).withDescription('Wind speed'),
        gust: () => new Text('gust', access.STATE).withDescription('Wind gust speed'),
